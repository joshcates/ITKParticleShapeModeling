...
namespace itk{
    ...
    void PSMProcrustesFunction::RunGeneralizedProcrustes(SimilarityTransformListType & transforms, ShapeListType & shapes)
    {
    ...
    PSMProcrustesFunction::ShapeType PSMProcrustesFunction::TransformShape(ShapeType shape, SimilarityTransform3D & transform)
    {
    ...
    PSMProcrustesFunction::RealType PSMProcrustesFunction::ComputeSumOfSquares(ShapeListType & shapes)
    {
    ...
    bool PSMProcrustesFunction::CheckDegenerateCase(PointType ssqShape, PointType ssqMean, PointType colMeanShape, PointType colMeanMean, int rows)
    {
        // TODO: Calculate standardized distance between mean of shapes and registered shape?
        ...
        // Check if any element in ssqShape and ssqMean is less than any element in valueShape and valueMean resp.
        for(int j = 0; j<dim; j++)
        {
    ...
    void PSMProcrustesFunction::LeaveOneOutMean(ShapeType & mean, ShapeListType & shapeList, ShapeListIteratorType & leaveOutIt)
    {
