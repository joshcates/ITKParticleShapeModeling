...
/*namespace itk{
    ...
    class MyProcrustesIterationCommand : public itk::Command
    {
    public:        
        /** Standard class typedefs. 
        typedef MyProcrustesIterationCommand  Self;
        typedef Command						  Superclass;
        typedef SmartPointer< Self >		  Pointer;
        typedef SmartPointer< const Self >	  ConstPointer;
        
        /** Run-time type information (and related methods). 
        itkTypeMacro(MyProcrustesIterationCommand, Object);
        /** Method for creation through the object factory. 
        itkNewMacro(MyProcrustesIterationCommand);
        
        void Execute(Object *caller, const EventObject & event)
        {
            Execute((const itk::Object *)caller, event);
            std::cout << "Running Generalized Procrustes Analysis" << std::endl;
            //PSMProcrustes *o = dynamic_cast<PSMProcrustes *>(caller);
    ...
    protected:
        MyProcrustesIterationCommand() {}
        ~MyProcrustesIterationCommand() {}
    private:
        MyProcrustesIterationCommand(const Self &);        //purposely not implemented
...
int itkPSMProcrustesFunctionTest( int argc, char* argv[] )
{
	...
	try
    {
        ...
        itk::MyProcrustesIterationCommand::Pointer mycommand = itk::MyProcrustesIterationCommand::New();
